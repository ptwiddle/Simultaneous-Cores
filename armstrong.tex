...
The simplex $\TD_a(b)$ is obtained by considering only those representations that have trivial determinant (i.e., $\wedge^b V=L_0$), or alternatively restricting to the index $a$ sublattice of $z_i$ satisfying $\sum iz_i=0\pmod a$.
...
The situation is illustrated in Figure \ref{fig:sublattice}: the left hand picture shows $\TD_3(10)\cong \SC_3(10)$
 while the right hand picture shows the standard simplex $10\Delta_3$.   The black dots are the representations with trivial determinant, while the red and green dots are those representations with determinant $L_1$ and $L_2$.  Rotating about the blue circle by 120 degrees corresponds to tensoring by $L_1$ and permutes the different colored dots.
...
+&q^5{k+2\brack 3}_{q^4}&+&q^9{k+2\brack 3}_{q^4}&+&q^9{k+1\brack 3}_{q^4}&+&q^{13}{k\brack 3}_{q^4} \\
