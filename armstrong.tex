...
The closest point to $0$ in the trivial orbifold coset is $x_0=(-1/3,0,1/3)$, which has weight $t^{3k+\delta}$, and the vertex closest to the origin in the nontrivial orbifold coset is $x_0^\prime=(-2/3,0,2/3)$, which has $\sk(x_0^\prime)=\ell(x_1^\prime=1)$, and so vertex contributes $(1, 3k+\delta-1)$.
...
The rays pointing inward to Chamber I at $x_1$ are $-v_1$and $v_2-v_1$; reading from Lemma \ref{ }, we see that these rays have $(\ell, \sk^\prime)$ weights $(-1, 2)$ and $(1, 0)$, respectively.  Thus the denominator from the Chamber I cosets will be $(1-q^{-1}t^2)(1-q)$.  The rays pointing inward to Chamber II at $x_1$ are $v_2-v_1$ and $v_2$; hence the denominator of the Chamber II will be $(1-q^2t^{-1})(1-q)$.

To find the numerators, we find the closest points in each chamber and relevant orbifold coset to $(-2b/9, b/9, b/9)$.

$$
\begin{array}{rrrrr|rr}
\text{point} & \shortstack{ \text{Shift from}\\ (-2k/3,k/3,k/3)} & \ell & \sk & \text{Coset} &  &  \\
\hline
w  & (1/3, -1/3, 0) & k-1 & 2k-2 & 1 & 1 & \\
x  & (0, -1/3, 1/3) & k &2k-1 & 2 & 1 & 1 \\ 
y & (-1/3, 0, 1/3) & k &2k & 1 & 2 & 1 \\
z & (-2/3, 0, 2/3) & k+1 & 2k+1 & 2 &   & 2 
\end{array}
$$
 
First, assume that $b=3k+1$, that is, $\delta=0$.  Then, the closest point in the trivial coset is $(-1/3, 0, 1/3)$, this point is $(-2k/3+1/3, k/3-1/3, k/3)$, in the other coset it is $(-2k/3, k/3-1/3, k/3+1/3)$, and the point closest to $x_1$ in Chamber 2 is $(-2k/3-1/3, k/3, k/3+1/3)$.

However, if we now increase $b$ by 1, making $\delta=1$, we see that the point $(-2k/3-1/3, k/3, k/3+1/3)$ now has $x_2-x_0=k+2/3=b/3$; thus it is no longer strictly in chamber II but on the wall of chamber I.  
